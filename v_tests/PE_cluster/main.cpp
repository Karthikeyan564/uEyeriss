// DESCRIPTION: Verilator: Verilog PE_cluster module Test
//
...
template<class module> class testbench {
    ...
    public:
        ...
        const std::unique_ptr<VPE_cluster> core{new VPE_cluster{contextp.get(), "PE_cluster"}};
        bool loaded = false;
...
int main(int argc, char** argv) {
    ...
    auto *core = new testbench<VPE_cluster>;
    ...
    std::cout<<"----- Final PSUM of Iteration 1: "<<(int)core->core->pe_out[0]<<"\n\n";
    ...
    std::cout<<"----- Final PSUM of Iteration 2: "<<(int)core->core->pe_out[0]<<"\n\n";
